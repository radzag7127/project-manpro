...
const properties: Property[] = [
  {
    ...
    description: "Sleek and modern apartment in the heart of Jakarta.",
    rating: 4.5,
    traditional: false,
    spiritual: false,
  },
  {
    ...
    imageUrl: "/placeholder.svg?height=200&width=300",
    description:
      "Experience the beauty of Balinese culture in this traditional villa.",
    rating: 4.8,
    traditional: true,
    spiritual: true,
  },
  {
    id: "3",
    title: "Spacious Family House in Bandung",
    price: 1500000000,
    location: "Bandung",
    type: "House",
    imageUrl: "/placeholder.svg?height=200&width=300",
  ...
  {
    id: "4",
    title: "Spiritual Retreat in Ubud",
    price: 1800000000,
    location: "Bali",
    type: "Villa",
    imageUrl: "/placeholder.svg?height=200&width=300",
    description: "Find peace and tranquility in this spiritual haven.",
    rating: 4.9,
    traditional: false,
    spiritual: true,
  },
  {
    ...
    type: "Apartment",
    imageUrl: "/placeholder.svg?height=200&width=300",
    description: "Enjoy breathtaking city views from this modern condo.",
    rating: 4.3,
    traditional: false,
    spiritual: false,
  },
  {
    ...
    type: "House",
    imageUrl: "/placeholder.svg?height=200&width=300",
    description: "Experience authentic Javanese architecture and culture.",
    rating: 4.7,
    traditional: true,
    spiritual: false,
  },
                ...
                <div className="py-4 space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) =>
                        applyFilters({ minPrice: Number(e.target.value) })
                      }
                    />
                    <Input
                      type="number"
                      ...
                      onChange={(e) =>
                        applyFilters({ maxPrice: Number(e.target.value) })
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          applyFilters({ traditional: checked === true })
                        }
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="spiritual"
                        onCheckedChange={(checked) =>
                          applyFilters({ spiritual: checked === true })
                        }
                      />
            ...
            <Card key={property.id}>
              ...
              <CardContent>
                ...
                {property.traditional && (
                  <span className="inline-block bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 mt-2">
                    Traditional
                  </span>
                )}
                {property.spiritual && (
                  <span className="inline-block bg-purple-100 text-purple-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-purple-200 dark:text-purple-800 mt-2">
                    Spiritual
                  </span>
                )}
              </CardContent>
