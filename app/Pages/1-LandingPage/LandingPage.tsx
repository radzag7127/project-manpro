...
const featuredProperties: Property[] = [
  { id: '1', title: 'Modern Apartment in Jakarta', price: 500000000, location: 'Jakarta', type: 'Apartment', imageUrl: '/placeholder.svg?height=200&width=300' },
  { id: '2', title: 'Cozy Villa in Bali', price: 2000000000, location: 'Bali', type: 'Villa', imageUrl: '/placeholder.svg?height=200&width=300' },
  { id: '3', title: 'Spacious House in Bandung', price: 1500000000, location: 'Bandung', type: 'House', imageUrl: '/placeholder.svg?height=200&width=300' },
]
      ...
      <main>
        ...
        <section className="bg-gradient-to-r from-primary to-primary-foreground text-white py-20">
          <div className="container mx-auto text-center">
            <h2 className="text-4xl font-bold mb-4">Find Your Dream Property with Rumaku</h2>
            <p className="text-xl mb-8">Fair exposure for all property owners, endless possibilities for buyers.</p>
        ...
        <section className="py-16">
          <div className="container mx-auto">
            <h3 className="text-3xl font-bold mb-8 text-center">Fair Exposure for All Sellers</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <Image src="/placeholder.svg?height=400&width=600" alt="Fair Exposure Illustration" width={600} height={400} className="rounded-lg shadow-lg" />
              </div>
              <div>
                <h4 className="text-2xl font-semibold mb-4">Why Choose Rumaku?</h4>
