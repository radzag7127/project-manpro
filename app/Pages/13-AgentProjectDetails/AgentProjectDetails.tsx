...
export function AgentProjectDetails() {
  ...
  const [property, setProperty] = useState<Property>({
    ...
    image: "/prop1.jpg",
    description:
      "Luxurious villa with modern amenities and beautiful garden views.",
    bedrooms: 4,
    bathrooms: 5,
    area: 500,
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              {property.owner && (
                <CardDescription className="mt-2 text-muted-foreground italic">
                  You're endorsing {property.owner.name} ({property.owner.type})
                </CardDescription>
              )}
            </div>
            <div className="flex gap-2">
              ...
              <Button
                variant="secondary"
                onClick={() => router.push(`/routes/promote-listings`)}
              >
